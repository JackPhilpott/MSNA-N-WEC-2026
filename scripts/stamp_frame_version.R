...
working_csv <- file.path(DATA_COLLECTION_DIR, "NGA_MSNA_2026_stage2_sampling_frame_v11_WORKING.csv")
strata_csv <- file.path(DATA_COLLECTION_DIR, "NGA_MSNA_2026_strata_level_sampling_frame_v11_WORKING.csv")
...
archive_before_fix <- function(reason, files = c(
  file.path(DATA_COLLECTION_DIR, "NGA_MSNA_2026_stage2_sampling_frame_v11_WORKING.csv"),
  file.path(DATA_COLLECTION_DIR, "NGA_MSNA_2026_strata_level_sampling_frame_v11_WORKING.csv")
)) {
