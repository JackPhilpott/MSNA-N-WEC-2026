# ==============================================================================
# 2026-09-21 late evening: copied for the v11 -> v12 bump (FRAME_VERSION only), per the
# rebuild-not-rename rule - the v12 rds is built BEFORE any script is repointed to it.
