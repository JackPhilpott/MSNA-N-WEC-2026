# ==============================================================================
# Builds NGA_MSNA_2026_sampling_frame_workbook_v8.xlsx from the state stashed
...
HOUSEHOLD_FULL_CSV = STATE_DIR + r"\NGA_MSNA_2026_stage2_sampling_frame_v12_FULL.csv"
STRATA_FULL_CSV = STATE_DIR + r"\NGA_MSNA_2026_strata_level_sampling_frame_v12_FULL.csv"
...
with open(STATE_DIR + r"\NGA_MSNA_2026_stage2_sampling_frame_v12_WORKING.csv", encoding="utf-8") as f:
...
write_sheet(
    ...
    "workbook for anyone who prefers CSV - see NGA_MSNA_2026_stage2_sampling_frame_v12_FULL.csv / _WORKING.csv.",
...
def write_readme():
    ...
    title("NGA MSNA 2026 — Sampling Frame + Partner Coverage Layer (v8)")
    para(
