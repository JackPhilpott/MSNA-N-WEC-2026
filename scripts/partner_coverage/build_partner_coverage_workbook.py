...
HOUSEHOLD_FULL_CSV = STATE_DIR + r"\NGA_MSNA_2026_stage2_sampling_frame_v13_FULL.csv"
STRATA_FULL_CSV = STATE_DIR + r"\NGA_MSNA_2026_strata_level_sampling_frame_v13_FULL.csv"
...
with open(STATE_DIR + r"\NGA_MSNA_2026_stage2_sampling_frame_v13_WORKING.csv", encoding="utf-8") as f:
...
write_sheet(
    ...
    "workbook for anyone who prefers CSV - see NGA_MSNA_2026_stage2_sampling_frame_v13_FULL.csv / _WORKING.csv.",
